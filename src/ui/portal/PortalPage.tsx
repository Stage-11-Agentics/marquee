...
type PortalSubmission = {
  ...
  decision_feedback: { markdown: string; decided_at: number | null } | null;
...
function StatusHero({ submission, index }: { submission: PortalSubmission; index: number }): JSX.Element {
