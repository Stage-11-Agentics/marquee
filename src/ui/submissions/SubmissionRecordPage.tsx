...
interface RecordData {
  ...
  actions: { can_decide: boolean; can_schedule: boolean; can_publish: boolean; can_edit_content: boolean };
}
  ...
  return <div class="submission-record-page">
    ...
    <div class="record-layout">
      <div class="record-main stack">
        ...
        <Card><CardHeader title="History"><span class="subtle">Every change, who made it, and when.</span></CardHeader><CardBody><ContentHistory entries={record.history} onRestore={canEditContent ? ((entryId) => void restoreVersion(entryId, isLivePublicly)) : undefined} busy={Boolean(busy)} label={statusLabel} moment={moment} livePublicly={isLivePublicly} /></CardBody></Card>
      </div>
