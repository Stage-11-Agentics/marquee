...
interface Round { id: string; name: string; mode: "scorecard" | "comparison"; position: number; target_reviews_per_submission: number; plan_status: string; reviewers: Assignment[]; evaluations: Array<{ abstained: boolean; score: number | null; recommendation: string | null; comment: string }>; comparisons: Array<{ ranking: unknown; submission_ids: string[]; reviewer_name: string }>; }
interface RecordData {
  ...
  evaluations: Array<{ abstained: boolean; round_id: string; round_name: string; reviewer_name: string; recommendation: string | null; score: number | null; comment: string }>;
