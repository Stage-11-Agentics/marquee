...
interface RecordData {
  ...
  decisions: Array<{ id: string; decision: string; resulting_status: string; feedback_md: string | null; decided_at: number; decided_by_name: string | null }>;
