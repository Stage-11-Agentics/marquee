...
export const CORE_TABLE_COUNT = CORE_TABLE_NAMES.length;
...
type _CoreTableCountIsDerived = Assert<Equal<typeof CORE_TABLE_COUNT, (typeof CORE_TABLE_NAMES)["length"]>>;
