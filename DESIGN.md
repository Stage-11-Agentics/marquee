...
`prototypes/` retains the public design inputs: the converged pipeline prototype and the Flight Deck skin. Product decisions are reflected in the checked-in implementation and evaluation contract.
