...
test("AC-407 · MRQ-248 · fetch transport sends canonical metadata paths and bodies", async () => {
...
test("AC-407 · MRQ-248 · schema keys, preferred shapes, and canonical record values are exhaustive", async () => {
...
test("AC-408 · MRQ-248 · verify is advisory, fresh/default bases offer explicit provisioning, and organizer Table 1 stays untouched", async () => {
  const clock = clockAt();
...
test("AC-409 · MRQ-248 · submitted differently named IDs are authoritative and map without createTable", async () => {
...
test("AC-409 · MRQ-248 · partial templates preserve submitted IDs and organizer columns while creating only unfilled roles", async () => {
...
test("AC-411 · MRQ-248 · verify never clears the active mapping; replacement state changes only at final adoption", async () => {
...
test("AC-411 · MRQ-248 · adoption is resumable and retry-safe after a rate-limited fifth field call", async () => {
...
test("AC-411 · MRQ-248 · the final continuation freshly rejects a previously completed table before the on-switch", async () => {
...
test("AC-410 · MRQ-248 · unknown provider fields remain unknown instead of becoming an empty schema", async () => {
...
test("AC-410 · MRQ-248 · computed and incomplete single-select fields conflict before webhook registration", async () => {
...
test("AC-409 · MRQ-248 · schema.bases:write copy is safe, and exact-name conflicts recover by rename then fresh creation", async () => {
