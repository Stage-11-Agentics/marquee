...
async function seedFixture(): Promise<void> {
  ...
  await run([
    ...
    statement("INSERT INTO calendar_invites (id, submission_id, person_id, uid, sequence, last_method, status, created_at, updated_at) VALUES ('invite_delete_204', 'submission_delete_204_session', ?, 'uid-delete-204', 0, 'REQUEST', 'active', ?, ?)", SPEAKER_ID, NOW, NOW),
