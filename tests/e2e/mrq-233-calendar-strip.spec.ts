...
// This spec runs only once the required env vars are set for an approved
// operator validation run; `test.skip`/`test.beforeEach` are avoided so
// every top-level `test.*` call stays a plain, statically-titled test (the
