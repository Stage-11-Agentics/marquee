...
test("CONTRACT · MRQ-129 precedence takes the first candidate the list actually contains", () => {
...
test("CONTRACT · MRQ-129 a candidate the list does not contain is skipped and reported as stale", () => {
...
test("CONTRACT · MRQ-129 every ghost is reported, and the first listed conference is the floor", () => {
...
test("CONTRACT · MRQ-129 a seat that can read no conference gets null rather than a guess", () => {
