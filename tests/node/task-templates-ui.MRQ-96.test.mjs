...
test("MRQ-96 · the existing task-template route is a real organizer editor", () => {
...
test("MRQ-96 · the editor offers named presets, arbitrary extensions, and MB limits", () => {
...
test("MRQ-96 · the speaker portal still renders the edited accepted line and limit", () => {
...
test("MRQ-96 · preset controls reserve their layout instead of reflowing when selected", () => {
