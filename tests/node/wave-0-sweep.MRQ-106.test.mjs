...
test("CONTRACT · MRQ-106 · the route map is generated and gated, never hand-written", async () => {
  ...
  // The route claims that shipped false twice. `/settings/webhooks` is not a
  // route; `/comms` is `/communications`; and `/agenda` is the public site, not
  // the organizer's builder.
  //
